...
public class MultiDataInsert extends HttpServlet {

    public void insertMultiData(HttpServletRequest request, HttpServletResponse response, KVStore kvstore) throws IOException, ServletException {
        ...
        try {
            ...
            for (i = 0; i < minorKeyCount; i++) {
                ...
                kvstore.putIfAbsent(Key.createKey(majorKeyComponent, minorKeyComponent[i]), Value.createValue(minorKeyValues[i].getBytes()));
            ...
            pw.println("<html>");
            pw.println("<head>");
            pw.println("<h3>Data Insertion Failed</h3>");
            pw.println("Following may be Reasons:</br>");
            pw.println("1. Data With Following Parameteres Must Be Already Available.</br>");
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        insertMultiData(request, response, kvstore);
