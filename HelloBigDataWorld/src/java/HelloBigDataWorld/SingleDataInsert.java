...
public class SingleDataInsert extends HttpServlet {

    public void insertData(HttpServletRequest request, HttpServletResponse response, KVStore kvstore) throws IOException, ServletException {
        ...
        try {
            ...
            Version putIfAbsent = kvstore.putIfAbsent(Key.createKey(majorKeyString, minorKeyString), Value.createValue(keyValue.getBytes()));
            long version = putIfAbsent.getVersion();
